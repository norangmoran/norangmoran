### ✨ 안녕하세요, 사용자 경험과 시스템 효율을 고민하는 개발자 모란입니다! ✨

지난 3년간의 직장 경험을 통해 사용자 경험 최적화와 시스템 개발 역량을 키워왔습니다.💪😎
...
이며 주요 업무는 다음과 같습니다.🛠️

<br/>

💡 관계형 메뉴 수정 시스템 개발

  기존 트리형 메뉴의 문제점을 해소하고자 더 효율적이고 빠른 메뉴 수정이 가능한 관계형 메뉴 수정 시스템을 개발하였습니다.

✅ 주문 관리 시스템 개발

  코드 재 사용성을 높인 POS 주문 관리 시스템을 개발해 최단시간 API 연동이 가능하도록 개발 편의성을 높였습니다.

📡 외부 API 연동

  다수의 배달대행사 API 연동 업무를 통해 HTTP 프로토콜을 깊이 이해하고, 더 빠른 주문 처리를 위해 시스템을 리뉴얼 하였습니다.

📊 데이터 분석 및 리포팅

  데이터베이스에서 기획 및 영업팀의 요청에 맞는 맞춤형 데이터를 추출하고 리포팅하여 데이터 기반의 의사결정을 지원했습니다.

<br/>

현재는 고객에게 더 나은 서비스 경험을 제공할 수 있는 풀스택 개발자를 목표로 Java와 React를 심도 깊게 학습하며 성장📈하고 있습니다.

함께 성장하고 새로운 도전을 함께 할 기회에 언제든 열려있으니 편하게 연락 주세요! 💌🚀
...
2. https://img.shields.io/badge/-{배지에 표시할 문자}-{css컬러}?logo={로고}&logoColor={로고컬러}&style={스타일} 표현식 작성하기
-->
...
![VS_Code](https://img.shields.io/badge/-VS_Code-4DAAFC?style=flat-square&logo=&logoColor=white)
...
[![Portfolio](https://img.shields.io/badge/-PHP_Portfolio-DD0B78?style=flat-square&logo=Starship&logoColor=white&link=http://weavingcoding.ohseon.com/)](http://weavingcoding.ohseon.com/)
